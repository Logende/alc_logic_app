...
class _ScreenSettingsState extends ConsumerState<ScreenSettings> {
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SwitchEqualDistrWidget(ref: ref, valueProvider: getValueProviderEqualDistr()),
  ...
  StateProvider<int> getValueProviderNumberThrows() {
    return StateProvider((ref) => ref.watch(modelProvider).numberOfThrows);
  }
  StateProvider<bool> getValueProviderEqualDistr() {
    return StateProvider((ref) => ref.watch(modelProvider).equalDistr);
  }

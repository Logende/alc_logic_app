...
class Dice {
  ...
  List<int> die = List<int>.filled(2, -1);
  
  int numberOfThrows = 0;

  // in case of dice 1 to 6 this list would start at 2 and go to 12
  List<int> sumStatistics = List<int>.filled(possibleOutcomesCount * 2 - 1, 0);
  List<List<int>> dieStatistics = List<List<int>>.filled(
      possibleOutcomesCount, List<int>.filled(possibleOutcomesCount, 0));
  ...
  void resetStatistics() {
    numberOfThrows = 0;
    sumStatistics = List<int>.filled(possibleOutcomesCount * 2 - 1, 0);
    dieStatistics = List<List<int>>.filled(
        possibleOutcomesCount, List<int>.filled(possibleOutcomesCount, 0));
  }
